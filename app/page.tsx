            ...
            <div className="flex justify-left">
                <div className="pt-44 pl-5">
                    ...
                    <div className="flex justify-left pt-5">
                        <p className="text-3xl dark:text-teal-400 pr-5">
                            Akihiro Ito
                        </p>
                        <svg className="w-6 h-9 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="pt-32 pl-20">
                    ...
                    <Image className="w-72 h-72 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={icon} alt="Bordered avatar" />
                </div>
            </div>
